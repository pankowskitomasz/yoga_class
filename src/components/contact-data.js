        ...
        return(        
            <Container fluid className={"contact-data align-items-center p-0 d-flex minh-50vh "+this.props.classExt}>
                <Row className="mx-auto text-center w-100 pt-5">
                    ...
                    <Col xs={10} md={6} className="mx-auto text-dark p-0 d-flex align-items-center">
                        <div className="p-5 contact-bg">
                            ...
                            <address className="d-block w-50 mx-auto p-2 mb-4 initialism text-center  text-muted">
                                00-001 City,<br/> 
                                Street 12A,<br/>
                                678 142 838<br/>
                                contact&#64;mail.it
