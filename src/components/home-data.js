        ...
        return(        
            <Container fluid className={"contact-data align-items-center p-0 d-flex minh-50vh "+this.props.classExt}>
                <Row className="mx-auto text-center w-100 pt-5">
                    <Col xs={10} md={6} className="mx-auto text-dark p-0 order-2 order-md-1">
                        <img alt="about"
                            className="img-fluid"
                            src="img/contact/contact-data.png"/>
                    </Col>
                    <Col xs={10} md={6} className="mx-auto text-dark p-0 d-flex order-1 order-md-2 align-items-center">
