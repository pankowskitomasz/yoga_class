...
class MessageTable extends Component {
    ...
    render() {
        ...
        return (
            <div>
                <Table striped bordered hover className="text-start w-100 border-caption">
                    <thead>
                        <tr className="text-caption border-caption">
                            <th>ID</th>
                            <th>Name</th>
                ...
                <div className="w-100 text-end">
                    <Button variant={"outline-light text-caption border-caption me-2"}
                        onClick={this.prevPage.bind(this)}>
                        &lt;
                    </Button>
                    <Button variant={"outline-dark text-caption border-caption"}
